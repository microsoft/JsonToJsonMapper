...
public class AutoMapperTest
{
  ...
  public void Validate_AutoMapper_ExceptionThrownByInvalidMappingJson()
  {
    ...
    var inputJson = "{\"name\": \"Rohit\",\"allowEmail\": false,\"SalesId\": null,\"Leadscore\":100}";
  ...
  {
    // Arrange
    var config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"Certain\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
  ...
  {
    // Arrange
    var config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"UtcNow\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    var input = "{\"value\":null}";
  ...
  {
    // Arrange
    var config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"NewGuid\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    var input = "{\"value\":null}";
  ...
  {
    // Arrange
    var config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":[{\"ExistingValue\": \"2\",\"NewValue\": 1},{\"ExistingValue\": \"1\",\"NewValue\": 2}, {\"ExistingValue\": \"0\",\"NewValue\": -1}],\"DefaultValue\":\"UtcNow\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    var input = "{\"value\":\"1\"}";
  ...
  {
    //Arrange - Certain input json with complex object
    var inputJson = @"{""eventId"": ""2353"",""externalKey"": ""AP-Azure"",""accountCode"": ""C-and-E"",""eventName"": ""Windows 10"",""eventQuestions"": {""question"": []}}";
  ...
  public void Automapper_EmptyDefaultValueTest()
  {
    //Arrange - Certain input json with complex object
    var inputJson = @"{""eventId"": ""2353"",""externalKey"": ""AP-Azure"",""accountCode"": ""C-and-E"",""eventName"": ""Windows 10"",""eventQuestions"": {""question"": []}}";
    var mapping = "{ \"MappingRuleConfig\": { \"TruthTable\": [ { \"SourceColumn\": \"\", \"DestinationColumn\": \"__meta__Entity\", \"DataType\": \"string\", \"ComplexType\": null, \"TransformValue\": { \"DefaultValue\": \"GenericPresales\" } }, { \"SourceColumn\": \"\", \"DestinationColumn\": \"EncryptedFields\", \"DataType\": \"string\", \"ComplexType\": null, \"TransformValue\": { \"DefaultValue\": \" \" } } ] } } ";
  ...
  public void FunctionTest_ReplaceValue_NullCompareToValueAndInputValue_RegexTest()
  {
    ...
    var inputJson = @"{'MessageBody': {'address': null}}";
    var mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': null ,'ReturnValue': 'def' ,'DefaultValue': 'fgh','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  {
    //Arrange - Certain input json 
    var inputJson = @"{'MessageBody': {'address': 'abc'}}";
    var mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': null ,'ReturnValue': null ,'DefaultValue': '$.MessageBody.address','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  public void FunctionTest_ReplaceValue_EmptyCompareToValue_RegexTest()
  {
    //Arrange - Certain input json 
    var inputJson = @"{'MessageBody': {'address': 'abc'}}";
    var mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': '' ,'ReturnValue': 'def' ,'DefaultValue': '$.MessageBody.address','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  {
    //Arrange - Certain input json with complex object
    var inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    var mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Key"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Key"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Delimeter"":""_"",""Index"":0,""Function"":""Split"",""Params"":[""$.Key""]}}]}}]}}";
  ...
  public void FunctionTest_TransformToUpperCase()
  {
    //Arrange - Certain input json with complex object
    var inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    var mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Data"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""EmailAddress"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Function"":""TOUPPERCASE"",""Params"":[""$.EmailAddress""]}}]}}]}}";
  ...
  public void FunctionTest_TransformToLowerCase()
  {
    //Arrange - Certain input json with complex object
    var inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    var mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Data"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""EmailAddress"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Function"":""TOLOWERCASE"",""Params"":[""$.EmailAddress""]}}]}}]}}";
