...
public class AutoMapperTest
{
  ...
  public void Validate_AutoMapper_InvalidDatatype()
  {
    ...
    const string inputJson = "{\"name\": \"Rohit\",\"allowEmail\": false,\"SalesId\": null,\"Leadscore\":100a}";
  ...
  {
    // Arrange
    const string mappingJson = "{\"MappingRuleConfig\":{\"DestinationType\": \"MipUnitTest.LeadRecord, JsonToJsonMapper.Core.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\",\"TruthTable\": [{\"SourceColumn\": \"Name\",\"DestinationColumn\": \"Name\",\"DataType\": \"string\",\"ComplexType\": null,\"TransformValue\": null},{\"SourceColumn\": \"LeadScore\",\"DestinationColumn\": \"LeadScore\",\"DataType\": \"int\",\"ComplexType\": null,\"TransformValue\": null},{\"SourceColumn\": \"AllowEmail\",\"DestinationColumn\": \"AllowEmail\",\"DataType\": \"bool\",\"ComplexType\": null,\"TransformValue\": null},{\"SourceColumn\": \"CrmId\",\"DestinationColumn\": \"CrmId\",\"DataType\": \"Guid\",\"ComplexType\": null,\"TransformValue\": null}]}}";

    const string inputJson = "{\"name\": null,\"allowEmail\": false,\"SalesId\": null,\"Leadscore\":100}";
  ...
  public void Validate_AutoMapper_EmptyString()
  {
    ...
    const string inputJson = "{\"name\": \"\",\"allowEmail\": false,\"SalesId\": null,\"Leadscore\":\"101\"}";
  ...
  public void Validate_AutoMapper_DateTimeValidation()
  {
    ...
    Assert.IsTrue(
      lead.Contains("2015-10-29T07:48:27.767-07:00") &&
      lead.Contains("2015-10-29T07:48:27.767-07:00") &&
      lead.Contains("11/02/2015 15:15:00 -08:00") &&
      lead.Contains("11/02/2015 16:30:00 -08:00") &&
      lead.Contains("8707"));
  }
  ...
  {
    // Arrange
    const string config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"Certain\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    const string input = "{\"value\":null}";
  ...
  {
    // Arrange
    const string config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"UtcNow\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    const string input = "{\"value\":null}";
  ...
  {
    // Arrange
    const string config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":null,\"DefaultValue\":\"NewGuid\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
    const string input = "{\"value\":null}";
  ...
  {
    // Arrange
    const string config = "{\"Type\":null,\"PrependKeyText\":null,\"ValueMapping\":[{\"ExistingValue\": \"2\",\"NewValue\": 1},{\"ExistingValue\": \"1\",\"NewValue\": 2}, {\"ExistingValue\": \"0\",\"NewValue\": -1}],\"DefaultValue\":\"UtcNow\",\"ScriptName\":null,\"Params\":null,\"KeyLookupField\":null,\"ValueLookupField\":null}";
  ...
  public void FunctionTest_ConCat_WithoutDelimiter()
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{'eventId': '2353','externalKey': 'AP-Azure','accountCode': 'C-and-E','eventName': 'Windows 10','eventQuestions': {'question': [{'questionField': 'evt_ans_field19','questionId': 638,'questionCode': 'Design-LPHeroImg','questionName': 'Design-LPHeroImg','answers': {'answer': [{'answerId': null,'answerCode': null,'value': 'https://info.microsoft.com'}]}},{'questionField': 'evt_ans_field24','questionId': 996,'questionCode': 'Design-EmailBannerImg','questionName': 'Design-EmailBannerImg ','answers': {'answer': [{'answerId': null,'answerCode': null,'value': 'First answer'},{'answerId': null,'answerCode': null,'value': 'Last answer'}]}},{'questionField': 'evt_ans_field24','questionId': 996,'questionCode': 'Design-EmailBannerImg','questionName': 'Design-EmailBannerImg ','answers': {'answer': [{'answerId': null,'answerCode': null,'value': ''}]}}]}}";
  ...
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{""eventId"": ""2353"",""externalKey"": ""AP-Azure"",""accountCode"": ""C-and-E"",""eventName"": ""Windows 10"",""eventQuestions"": {""question"": []}}";
  ...
  public void Automapper_EmptyDefaultValueTest()
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{""eventId"": ""2353"",""externalKey"": ""AP-Azure"",""accountCode"": ""C-and-E"",""eventName"": ""Windows 10"",""eventQuestions"": {""question"": []}}";
    const string mapping = "{ \"MappingRuleConfig\": { \"TruthTable\": [ { \"SourceColumn\": \"\", \"DestinationColumn\": \"__meta__Entity\", \"DataType\": \"string\", \"ComplexType\": null, \"TransformValue\": { \"DefaultValue\": \"GenericPresales\" } }, { \"SourceColumn\": \"\", \"DestinationColumn\": \"EncryptedFields\", \"DataType\": \"string\", \"ComplexType\": null, \"TransformValue\": { \"DefaultValue\": \" \" } } ] } } ";
  ...
  {
    //Arrange - Certain input json with complex object
    const string inputJson = "{ \"mipmsxPreferenceTopic\": \"MOD\", \"JobTitle\": \"Webmaster and Records Manager\", \"BusinessPhone\": \"+15563213567\", \"MobilePhone\": 1234565430, \"CountryOrRegion\": \"United Sates\", \"mipmsxPreferenceType\": \"Topic\", }";
  ...
  [TestMethod, Description("Function handler test - Validate that the value returned is replaced value When Path is given.")]
  public void FunctionTest_ReplaceValueNode_Success()
  {
    //Arrange - Certain input json with complex object
    const string inputJson = "{ \"mipmsxPreferenceTopic\": \"MOD\", \"JobTitle\": \"Webmaster and Records Manager\", \"BusinessPhone\": \"+15563213567\", \"MobilePhone\": 1234565430, \"CountryOrRegion\": \"United Sates\", \"mipmsxPreferenceType\": \"Topic\", }";
  ...
  {
    //Arrange - Certain input json with complex object
    const string inputJson = "{ \"mipmsxPreferenceTopic\": \"MOD\", \"JobTitle\": \"Webmaster and Records Manager\", \"BusinessPhone\": \"+15563213567\", \"MobilePhone\": 1234565430, \"CountryOrRegion\": \"United Sates\", \"mipmsxPreferenceType\": null, }";
    const string mapping = @"{'MappingRuleConfig':{'TruthTable':[{'SourceColumn':'','DestinationColumn':'Output','DataType':'string','ComplexType':{'DataType':'string','Node':'$','TruthTable':[{'SourceColumn':'','DestinationColumn':'PreferenceTopic','DataType':'string','TransformValue':{'Type':'function','CompareToValue':'$.JobTitle','ReturnValue':'$.MobilePhone','DefaultValue':'$.mipmsxPreferenceTopic','Function':'ReplaceValue','Params':['$.mipmsxPreferenceType']}}]}}]}}";
  ...
  {
    //Arrange - Certain input json with complex object
    const string inputJson = "{ \"mipmsxPreferenceTopic\": \"MOD\", \"JobTitle\": \"Webmaster and Records Manager\", \"BusinessPhone\": \"+15563213567\", \"MobilePhone\": \"+1234565430\", \"CountryOrRegion\": \"United Sates\", \"mipmsxPreferenceType\": \"Mswide\", }";
  ...
  public void FunctionTest_ReplaceValue_NullCompareToValueAndInputValue_RegexTest()
  {
    ...
    const string inputJson = @"{'MessageBody': {'address': null}}";
    const string mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': null ,'ReturnValue': 'def' ,'DefaultValue': 'fgh','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  public void FunctionTest_ReplaceValue_NullCompareToValue_RegexTest()
  {
    //Arrange - Certain input json 
    const string inputJson = @"{'MessageBody': {'address': 'abc'}}";
    const string mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': null ,'ReturnValue': null ,'DefaultValue': '$.MessageBody.address','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  public void FunctionTest_ReplaceValue_EmptyCompareToValue_RegexTest()
  {
    //Arrange - Certain input json 
    const string inputJson = @"{'MessageBody': {'address': 'abc'}}";
    const string mapping = @"{'MappingRuleConfig': {  'TruthTable': [{'SourceColumn': '$.MessageBody.address','DestinationColumn': 'address','DataType': 'String','ComplexType': null,'TransformValue': {'Type': 'function','CompareToValue': '' ,'ReturnValue': 'def' ,'DefaultValue': '$.MessageBody.address','Function': 'ReplaceValueWithRegexComparison','Params': ['$.MessageBody.address']}}]}}";
  ...
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    const string mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Key"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Key"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Delimeter"":""_"",""Index"":0,""Function"":""Split"",""Params"":[""$.Key""]}}]}}]}}";
  ...
  public void FunctionTest_TransformToUpperCase()
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    const string mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Data"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""EmailAddress"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Function"":""TOUPPERCASE"",""Params"":[""$.EmailAddress""]}}]}}]}}";
  ...
  public void FunctionTest_TransformToLowerCase()
  {
    //Arrange - Certain input json with complex object
    const string inputJson = @"{""LeadId"":""2353"",""FirstName"":""AP-Azure"",""LastName"":""C-and-E"",""EmailAddress"":""Windows 10"",""Key"":""12121212333_AKJKKAJDKAKJKKKDKSKAK""}";
    const string mapping = @"{""MappingRuleConfig"":{""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""Data"",""DataType"":""string"",""ComplexType"":{""DataType"":""jArray"",""Node"":""$"",""TruthTable"":[{""SourceColumn"":"""",""DestinationColumn"":""EmailAddress"",""DataType"":""string"",""TransformValue"":{""Type"":""function"",""Function"":""TOLOWERCASE"",""Params"":[""$.EmailAddress""]}}]}}]}}";
  ...
  public void AutoMapperMappingForJObjectAndJArray()
  {
    // Arrange
    const string inputJson =
  ...
  public void AutoMapperMapping_ValidateDateTimeFormat()
  {
    // Arrange
    const string inputJson =
  ...
  public void AutoMapperMapping_ConcatWithNull()
  {
    // Arrange
    const string inputJson =
  ...
  [TestMethod, Description("Validate that the concatenation where nulls are present.")]
  public void AutoMapperMapping_ConcatWithEmptyList()
  {
    // Arrange
    const string inputJson =
  ...
  public void AutoMapperMapping_RemoveDateTimeOffsetTest_WithOffset()
  {
    // Arrange
    const string inputJson =
  ...
  public void AutoMapperMapping_RemoveDateTimeOffsetTest_WithoutOffset()
  {
    // Arrange
    const string inputJson =
  ...
  public void AutoMapperMapping_ReplaceValueFunction_HappyPath()
  {
    // Arrange
    const string inputJson =
  ...
  [TestMethod, Description("Validate ReplaceValueFunction.")]
  public void AutoMapperMapping_ReplaceValueFunction_ParamNull()
  {
    // Arrange
    const string inputJson =
  ...
  [TestMethod, Description("Validate ReplaceValueFunction.")]
  public void AutoMapperMapping_ReplaceValueFunction_ReturnValueNullParamNull()
  {
    // Arrange
    const string inputJson =
  ...
  [TestMethod, Description("Validate ReplaceValueFunction.")]
  public void AutoMapperMapping_ReplaceValueFunction_ParamEmptyString()
  {
    // Arrange
    const string inputJson =
  ...
  [TestMethod, Description("Validate ReplaceValueFunction.")]
  public void AutoMapperMapping_ReplaceValueFunction_ParamNullReturnValueEmpty()
  {
    // Arrange
    const string inputJson =
  ...
  public void FunctionHandler_UriEscapeDataString_HappyPath_Dollar()
  {
    // Arrange
    const string inputJson =
      "{ \"data\": { \"companyName\": \"Procter $ Gamble Company\", \"countryName\": \"Bulgaria\", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
  ...
  public void FunctionHandler_UriEscapeDataString_HappyPath_Space()
  {
    // Arrange
    const string inputJson =
      "{ \"data\": { \"companyName\": \"Procter Gamble Company\", \"countryName\": \"Bulgaria \", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
  ...
  public void FunctionHandler_UriEscapeDataString_HappyPath_Exclamation()
  {
    // Arrange
    const string inputJson =
      "{ \"data\": { \"companyName\": \"Procter!Gamble Company\", \"countryName\": \"Bulgaria \", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
  ...
  public void FunctionHandler_UriEscapeDataString_Null_Parameters()
  {
    // Arrange
    const string inputJson = "{ \"data\": { \"companyName\": \"Procter!Gamble Company\", \"countryName\": \"Bulgaria \", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
    const string mappingJson = "{ \"MappingRuleConfig\": { \"TruthTable\": [ { \"SourceColumn\": \"\", \"DestinationColumn\": \"dummy\", \"DataType\": \"string\", \"TransformValue\": { \"Type\": \"function\", \"Function\": \"UriEscapeDataString\", \"Params\": null } } ] } } ";
  ...
  public void FunctionHandler_UriEscapeDataString_One_Null_Parameter()
  {
    // Arrange
    const string inputJson = "{ \"data\": { \"companyName\": \"Procter!Gamble Company\", \"countryName\": \"Bulgaria \", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
  ...
  public void FunctionHandler_UriEscapeDataString_Invalid_Parameter_Field()
  {
    // Arrange
    const string inputJson = "{ \"data\": { \"companyName\": \"Procter!Gamble Company\", \"countryName\": \"Bulgaria \", \"state\": \"\", \"city\": \"Sofia\", \"zipCode\": \"1510\", \"DunnsId\": null } } ";
